...
async function updateSupabaseConfig() {
  log('🔧 Supabase Configuration Updater', colors.bright);
  log('==================================\n', colors.bright);
  ...
  if (!projectIdMatch) {
    log('\n❌ Invalid Supabase URL format!', colors.red);
  ...
  log('\n📋 Configuration to update:', colors.cyan);
...
VITE_SUPABASE_ANON_KEY=${anonKey}`;
    ...
    log('  ✅ Updated .env file', colors.green);
  } catch (error) {
    log(`  ❌ Failed to update .env: ${error.message}`, colors.red);
  }
...
`;
    ...
    log('  ✅ Updated src/utils/supabase/info.tsx', colors.green);
  } catch (error) {
    log(`  ❌ Failed to update info.tsx: ${error.message}`, colors.red);
  }
